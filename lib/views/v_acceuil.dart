...
class HomePagess extends StatefulWidget {
  ...
  const HomePagess({super.key, required this.pclient});
...
class _HomePageState extends State<HomePagess> {
  ...
  final coachController = Get.put(CoachController());
  ...
  void initState() {
    super.initState();
    // Start the auto-refresh timer when the widget is first initialized
    coachController.fetchCoachs();
    etablissementController.fetchEtablissements();
  }
  ...
  Future<void> _refresh() {
    coachController.fetchCoachs();
    courController.fetchCours();
    return etablissementController.fetchEtablissements();
  }
  ...
  Widget _horizontalScrollSnapList3() {
    // create an instance of EtablissementController and register it with the GetX framework
    return Obx(() {
